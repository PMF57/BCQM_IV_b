...
from .model import GraphState, ProbeState, Params, initialise_graph, initialise_probe, make_params, current_position, step_probe
...
def simulate_trajectory(cfg: Config, w_coh: float, rng: np.random.Generator) -> TrajectoryResult:
    ...
    for n in range(n_steps):
        ...
        probe = step_probe(probe, graph, params, rng)
